...
##        for i in range(4):
##                    for j in range(4):
##                        print(hex(int(round_key[j][i])),end=" ")
##        print()
        # print("----add round key----")
    ...
    def decode(self):
        ...
        #print("byte 12,13 Ciphertext: ")
        #print(hex(int(self.__src[0][3])),end=" ")
        #print(hex(int(self.__src[1][3])),end=" ")
                    ...
                    for j in range(3):
                        ...
                        for r in range(3):
                            for c in range(3):
                                if(c!=j):
                                    if(tem==ans[r][c]):
                                        storeposition.append(i)
                                        storeposition.append(j)
    
                if(len(storeposition)>=3):
                     C12 = hex(self.__src[storeposition[0]][storeposition[1]])    # byte 12 Ciphertext
                     B12C = ((int((C12),16)))
                     C13 = hex(self.__src[storeposition[2]][storeposition[3]])    # byte 13 Ciphertext
                     B13C = ((int((C13),16)))
##                     S12 = hex(ans[0][3])           # byte 12 intermediate value (before lastround key)
##                     B12S = ((int((S12),16)))        
##                     S13 = hex(ans[1][3])          # byte 12 intermediate value (before lastround key)
##                     B13S = ((int((S13),16)))
                     storeposition = []
                     tem = 0
...
if __name__ == '__main__':
    ...
    for i in range(len(faultylist)):
        ...
        ##    ],dtype=np.int64)
            ...
            ans2 = aes.decode()   ####beware
print(counter)
cnt = collections.Counter(argument)
print(cnt)
    #for i in range(4):
        #for j in range(4):
            #print(hex(int(ans[j][i])),end=" ")
##    print()
##    print("Last Round: ")
##    for i in range(4):
##        for j in range(4):
##            print(hex(int(ans2[j][i])),end=" ")
